        ...
        },
        {
          ...
          upsert: true,
			...
			Buttons.addComponents(
				new MessageButton().setCustomId(FirstButton[0]).setLabel(FirstButton[0]).setStyle('PRIMARY').setEmoji(FirstEmoji),
				new MessageButton().setCustomId(SecondButton[0]).setLabel(SecondButton[0]).setStyle('SUCCESS').setEmoji(SecondEmoji),
				new MessageButton().setCustomId(ThirdButton[0]).setLabel(ThirdButton[0]).setStyle('SECONDARY').setEmoji(ThirdEmoji)
			);

const { ChatInputCommandInteraction, Client, version, EmbedBuilder, Colors, ChannelType } = require('discord.js');
const { connection } = require('mongoose');
const os = require('os');

/*
created by KevinFoged
Github: https://github.com/KevinFoged
*/
	...
	async execute(interaction, client) {
		...
		const embed = new EmbedBuilder()
			...
			.addFields(
				...
				{ name: '☑ Verified', value: client.user.flags.has('VerifiedBot') ? 'Yes' : 'No', inline: true },
				{ name: '👩🏻‍💻 Bot Owner', value: `${interaction.client.application.owner.tag || 'None'}`, inline: true },
				...
				{ name: '🧵 Threads', value: `${getChannelTypeSize([ChannelType.GuildNewsThread, ChannelType.GuildPublicThread, ChannelType.GuildPrivateThread])}`, inline: true }
			)

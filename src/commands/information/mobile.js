	...
	*/
	async execute(interaction) {
		...
		if (target) {
			...
			interaction.editReply({ content: `${target}`, embeds: [mobileEmbed] });
			interaction.followUp({ content: 'You can also: Vote for this Twitch suggestion https://twitch.uservoice.com/forums/904711-extensions/suggestions/40301335 Contact Twitch Support https://help.twitch.tv/s/contactsupport and request better extension support on mobile For more information, see https://github.com/overlay-expert/help-desk/issues/97.' });
		}
		else {
			await interaction.deferReply();
			mobileEmbed.setTitle('Overlay Expert');
			interaction.editReply({ embeds: [mobileEmbed] });
			interaction.followUp({ content: 'You can also: Vote for this Twitch suggestion https://twitch.uservoice.com/forums/904711-extensions/suggestions/40301335 Contact Twitch Support https://help.twitch.tv/s/contactsupport and request better extension support on mobile For more information, see https://github.com/overlay-expert/help-desk/issues/97.' });
			mobileEmbed.setTitle(`${target.tag}`);
